  ...
  if (items.length === 0) {
    return (
      <div className="max-w-2xl mx-auto px-5 py-24 text-center">
        ...
        <h1 className="font-display text-4xl mt-8">{t("cart.emptyTitle")}</h1>
  ...
  return (
    <div className="max-w-6xl mx-auto px-5 lg:px-10 py-12 lg:py-16">
      <div className="flex items-end justify-between flex-wrap gap-3 mb-10">
        <div>
          <p className="text-[10px] tracking-[0.4em] uppercase text-gold">{t("cart.yourBag")}</p>
          <h1 className="font-display text-4xl lg:text-5xl mt-3">{t("cart.checkout")}</h1>
        </div>
        <button
          onClick={clear}
